# mulle-c-developer Library Documentation for AI

## 1. Introduction & Purpose

**mulle-c-developer** is a mulle-sde developer kit that provides development tools, build extensions, and utilities for developing and debugging mulle-c projects.
...
**When to Use:**
- Adding to development environments for mulle-c work
- Setting up build systems for mulle-c projects
...
- **Extension Model**: Extends mulle-sde with mulle-c-specific behavior
...
- Build flags for mulle-c projects
- Compiler settings
- Path configurations
...
**Purpose**: Configure mulle-sde build environment for mulle-c development
...
- **Project Setup**: Add mulle-c-developer early in project initialization
...
```bash
# With mulle-c-developer installed, builds have enhanced configuration
mulle-sde craft  # Uses mulle-c-optimized settings
...
```bash
# Initialize new mulle-c project
mulle-sde init -d mulle-c myproject
cd myproject

# Add development kit for building
mulle-sde add --github mulle-c mulle-c-developer

# Now builds use mulle-c-developer settings
mulle-sde craft
```
...
```bash
# After adding mulle-c-developer, shell environment configured automatically
# Scripts in .mulle/share/env/ are sourced

# Developers have convenient shell aliases available in interactive mode:
alias c="mulle-sde craft"        # Quick compile
alias C="mulle-sde clean; mulle-sde craft"  # Clean compile
alias r="mulle-sde reflect"      # Reflect filesystem changes
alias l="mulle-sde list --files" # List project files
```
...
- mulle-c-cc (compiler configuration)
